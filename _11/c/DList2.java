...
public class DList2 {
  ...
  public void insertFront(int i) {
    ...
    temp.prev = head;
    temp.next = head.next;
    //let the current front element previous point to new node
    head.next.prev = temp;
    //have the head next point to new element
  ...
  public boolean equals(Object obj){
    if(!(obj instanceof DList2))
      return false;
    DList2 d2 = (DList2)obj;

    if(this.size != d2.size)
      return false;

    DListNode2 n1 = this.head.next;
    DListNode2 n2 = d2.head.next;
    while(n1 != this.head){
      if(!(n1.item == n2.item))
        return false;
      n1 = n1.next;
